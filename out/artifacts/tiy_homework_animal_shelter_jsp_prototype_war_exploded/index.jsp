...
<div class="container">
    ...
    <div class="row u-max-full-width bodyText">
        <div class="six columns">
            <button class="button-primary" ref="/listpage/html" style="width: 100%">List Critter</button>
        </div>
        <div class="six columns">
            <button class="button-primary" ref="/createpage.html" style="width: 100%">Create Critter</button>
        </div>
    </div><!--row-->
